...
card:
  ...
  answer: "Eine DMZ, also demilitarisierte Zone, ist ein abgeschotteter Netzwerkbereich zwischen Internet und internem Netzwerk. Dort werden öffentlich erreichbare Dienste betrieben, zum Beispiel Web- oder Mailserver, ohne das interne Firmennetz direkt freizugeben."
  examples:
    - "Ein Webserver steht in der DMZ, damit Internetnutzer darauf zugreifen können."
    - "Ein Mailserver in der DMZ verarbeitet eingehende E-Mails und leitet sie kontrolliert weiter."
    - "Die DMZ schützt das interne Netzwerk, falls ein öffentlich erreichbarer Server angegriffen wird."
